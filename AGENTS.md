...
- Do not require explicit consent before creating a new isolated worktree.
- Automatically use inline execution for small changes, rather than subagent-driven.
...
- Use snakeCase filenames (e.g., `userSession.ts`, `dataService.ts`) unless told otherwise.
